...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Category List", route: "/dashboard/category-list" },
          { label: "Product List", route: "/dashboard/product-list" },
          { label: "Author List", route: "/dashboard/author-list" },
          { label: "Staff List", route: "/dashboard/staff-list" },
          { label: "Customer List", route: "/dashboard/customer-list" },
          { label: "Publisher List", route: "/dashboard/publisher-list" },
          { label: "Review List", route: "/dashboard/review-list" },
          { label: "Order List", route: "/dashboard/order-list" },
          { label: "Stock List", route: "/dashboard/stock-list" },
          { label: "Discount List", route: "/dashboard/discount-list" },
          { label: "Banner List", route: "/dashboard/banner-list" },
          { label: "Shipping Methods List", route: "/dashboard/shipping-methods-list" },
          { label: "Payment List", route: "/dashboard/payment-list" },
          { label: "Wish List", route: "/dashboard/wish-list" },
        ],
      },
      {
        icon: (
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Form Elements", route: "/dashboard/forms/form-elements" },
          { label: "Form Layout", route: "/dashboard/forms/form-layout" },
        ],
      },
      {
        icon: (
  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Alerts", route: "/dashboard/ui/alerts" },
          { label: "Buttons", route: "/dashboard/ui/buttons" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Sign In", route: "/dashboard/auth/signin" },
          { label: "Sign Up", route: "/dashboard/auth/signup" },
        ],
      },
    ],
  },
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/dashboard" className="flex justify-center items-center gap-5">
            <Image
              width={70}
              height={70}
              src={"https://shopping.bookoff.co.jp/library/common/svg/yomuyomu-kun.svg"}
              alt="Logo"
              priority
            />
            <p className="font-bold text-[#fff] text-[32px]">Bookoff</p>
          </Link>
