...
const config: Config = {
  content: [
    "./src/app/(dashboard)/dashboard/**/*.{js,jsx,ts,tsx}", // Đường dẫn đến các file trong dashboard
    "./src/components/dashboard/**/*.{js,jsx,ts,tsx}", // Đường dẫn đến các file trong dashboard
  ],
  darkMode: "class",
  theme: {
    fontFamily: {
